...
<div class="row">
    <div class="col-md-12">
        <div class="panel-heading">
            <h3 class="panel-title">Registrar Nueva Persona</h3><hr>
        </div>
            <?= $form->inicia(['id'=>'form_persona','action'=>'/0/7/nuevo'],$persona); ?>
                <fieldset>
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <p>
                        ...
                        <?= Url::linkF('nuevo','Guardar','form_persona',['class'=>'btn btn-info']) ?>
                    </p>
                </fieldset>
            <?= $form->fin() ?>
    </div>
